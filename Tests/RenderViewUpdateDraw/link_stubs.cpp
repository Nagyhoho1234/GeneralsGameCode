// Harness-local link stubs, unchanged verbatim from Tests/RenderCameraTransform/
// link_stubs.cpp - see main.cpp's own header comment for why this Milestone
// 11 (Draft 35) harness reuses Tests/RenderCameraTransform's structure
// wholesale rather than Draft 35's originally-scoped five-class stub
// surface (a genuine, newly-discovered link-time blocker, not a shortcut).
// pickDrawable() (this harness's own new Check 8) needs NO new stubs beyond
// what is already here: TheWindowManager stays null (already stubbed
// below, already null-guarded by pickDrawable() itself), and
// W3DDisplay::m_3DScene is already the real, constructed RTS3DScene
// (Milestone 8's own technique, unchanged).
//
