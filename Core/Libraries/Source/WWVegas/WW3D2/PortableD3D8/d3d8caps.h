...
// Stand-in for Microsoft's d3d8caps.h on non-Windows. D3DCAPS8's fields are
// copied verbatim from the real SDK header - DX8Caps/Compute_Caps (the code
// that actually populates and reads this struct) isn't reached in Phase
// 5(a) Milestone 1, but dx8wrapper.h's `DX8Caps* CurrentCaps` member and
// dx8caps.h's method declarations must still compile.
#pragma once

#ifndef PORTABLE_D3D8CAPS_H
#define PORTABLE_D3D8CAPS_H
