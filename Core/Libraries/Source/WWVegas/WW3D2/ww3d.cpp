...
// WW3D's static member variable definitions moved to ww3d_common.cpp (native
// port plan Phase 5(a) Milestone 3, finding 2) - referencing ww3d.h's inline
// accessors (Get_Sync_Time, Is_Sorting_Enabled, Is_Snapshot_Activated, ...)
